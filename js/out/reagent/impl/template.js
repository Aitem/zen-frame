...
var G__5195 = o;
(G__5195[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__5201 = jsprops;
(G__5201["defaultValue"] = value);

(G__5201["onChange"] = ((function (G__5201,v,value,on_change){
return (function (p1__5200_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5200_SHARP_);
});})(G__5201,v,value,on_change))
);
...
var vec__5204 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5204,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5204,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5204,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___5208 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___5208 == null)){
} else {
var key_5209 = temp__5724__auto___5208;
(jsprops["key"] = key_5209);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__5210 = reagent.impl.template.__GT_NativeWrapper();
(G__5210["name"] = c);
...
var G__5211 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5211) : reagent.impl.template.as_element.call(null,G__5211));
} else {
...
var len__4730__auto___5217 = arguments.length;
var i__4731__auto___5218 = (0);
while(true){
if((i__4731__auto___5218 < len__4730__auto___5217)){
args__4736__auto__.push((arguments[i__4731__auto___5218]));

var G__5219 = (i__4731__auto___5218 + (1));
i__4731__auto___5218 = G__5219;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5215){
var G__5216 = cljs.core.first(seq5215);
var seq5215__$1 = cljs.core.next(seq5215);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5216,seq5215__$1);
});
...
break;
default:
var G__5222 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__5222;
continue;
...
var n__4607__auto___5224 = a.length;
var i_5225 = (0);
while(true){
if((i_5225 < n__4607__auto___5224)){
(a[i_5225] = reagent.impl.template.as_element((a[i_5225])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___5227 = a.length;
var i_5228 = (0);
while(true){
if((i_5228 < n__4607__auto___5227)){
var val_5229 = (a[i_5228]);
if(((cljs.core.vector_QMARK_(val_5229)) && ((reagent.impl.template.key_from_vec(val_5229) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5228] = reagent.impl.template.as_element(val_5229));
...
var ctx = ({});
var vec__5231 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5231,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5231,(1),null);
...
var G__5234 = (cljs.core.count(argv) - first_child);
switch (G__5234) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__5234){
